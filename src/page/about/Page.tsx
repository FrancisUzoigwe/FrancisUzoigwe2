      ...
      <div className="flex w-[90%] justify-between max-md:flex-col-reverse">
        <div className=" w-[70%] max-md:w-full" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
          ...
          <div className="text-[14px] w-[95%] mt-3">
            <div id="main" className="opacity-0 translate-y-4 w-full"> <span className="font-bold">My journey </span>into web development began in 2016 when I discovered a free coding workshop at my local library. Fascinated by how websites were built, I got enrolled in a coding institute <a className="underline font-bold italic" href="https://codelab-home.web.app">CodeLab</a> where I met like minds. I created my first site using HTML and CSS. This initial project ignited my passion for web development, leading me to explore various online resources such as Codecademy and freeCodeCamp and books like "HTML and CSS: Design and Build Websites" to build a strong foundation. </div>
          </div>
          <div className="text-[14px] w-[95%] mt-3">
