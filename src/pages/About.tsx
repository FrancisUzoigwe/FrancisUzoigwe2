...
const About = () => {
    return (
        <div className="w-full min-h-[70vh] flex flex-col items-center bg-[#f0f3f5]" id="about">
            ...
            <div className="my-2" />
            <div className="w-[90%] my-2 text-[20px] font-bold max-md:text-[16px]">Proficiency:</div>
